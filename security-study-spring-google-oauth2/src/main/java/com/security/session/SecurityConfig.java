...
import com.security.session.spring.RestAuthenticationEntryPoint;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		web.ignoring().antMatchers("/error/**", "/login/google", "/auth/logout");
	}
...
//			.addFilterBefore(jwtAuthenticationFilter(), UsernamePasswordAuthenticationFilter.class)
	...
	public JwtAuthenticationFilter jwtAuthenticationFilter() throws Exception {
		...
		jwtAuthenticationFilter.setRequiresAuthenticationRequestMatcher(new AntPathRequestMatcher("/auth/login", "GET"));
	...
	@Bean
	public FilterRegistrationBean<JwtTokenFilter> jwtTokenFilterBean() throws Exception{
